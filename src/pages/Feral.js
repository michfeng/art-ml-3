...
import img3 from "../images/wild-cluster2 2.gif";
...
import sound3 from '../audio-files/tents-description.mp3'
import sound4 from '../audio-files/fiery-hot-description.mp3'
...
function Feral () {
    return (
        <div class="container" style={{paddingTop: '200px'}}>
            ...
            <Media image={img4} caption="Fiery entertainment at a dark, leather-filled party" sound={sound4} prompt="Going out with a group of my friends, clubbing with my friends."/>
            <Media image={img3} caption="Carnival-like dotted color palette in 3D" sound={sound3} prompt="Carnival, Spring carnival at CMU"/>
        </div>
    );
}
