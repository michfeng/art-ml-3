...
function Whimsical () {
    return (
        <div class="container" style={{paddingTop: '200px'}}>
            <Media image={img1} caption="Butterflies and pink frilly dresses." sound={sound1} prompt="classical music, folklore by Taylor Swift, Music? I don’t feel whimsical super often , jumping in puddles, dancing but not somewhere where everyone else is, Harry potter,  I Think You Should Leave, clown,  books and movies,  lisa frank products, Trundle Manor, A little girl prancing around,  broadway, disneyworld, Willy Wonka,  A+C engraved in the tree, any sunrise, dewdrops on leaves,  ballet, winnie the pooh, animated Disney movies, the wizard of oz, dancing in the woods, Atlantis,  living in a cloud world,  Barbie land, when i'm delusional and on no sleep and start laughing at everything, Disneyland,  Cartoons,  the Circus, abstract,  colors,  small door in the middle of the woods, "/>
            <Media image={img2} caption="Colorful fairies with wings." sound={sound2} prompt="fairies."/>
            <Media image={img3} caption="Glowing town view of Candyland." sound={sound3} prompt="candy land"/>
        </div>
    )
}
